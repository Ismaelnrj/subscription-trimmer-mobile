...
const TERMS_SECTIONS = [
  ...
  { title: '2. Acceptance', body: 'By creating an account or using the Service you agree to these Terms. If you do not agree, please do not use the Service. Your use of the Service is also governed by our Privacy Policy, which explains how we handle your information.' },
  ...
  { title: '5. Your Account', body: 'You are responsible for keeping your login details confidential and for activity that happens under your account. Please tell us promptly at Trimio@subtrimio.com if you believe your account has been used without your permission. You may delete your account at any time from the Account Settings screen in the app.' },
  { title: '6. Your Content', body: 'The subscription details you enter remain yours. You grant us only the permission needed to store and display that information back to you, and to operate features you have enabled, such as reminders. We do not sell your content and we do not use it for advertising.' },
  { title: '7. Free and Premium Plans', body: 'Trimio is free to use for up to five subscriptions. A Premium plan removes that limit and unlocks additional features, which are described in the app at the point of purchase. We may change what each plan includes, and if a change materially reduces what you already pay for, we will tell you in advance.' },
  { title: '8. Payments, Renewals and Refunds', body: 'Premium is sold through Google Play Billing. Google, not Trimio, is the seller of record for that transaction. Prices are shown in the app before you confirm. A Premium subscription renews automatically until you cancel it, and you cancel or manage it through your Google Play account rather than through Trimio. Refund requests are handled by Google under Google Play policies. We never see or store your card details.' },
  ...
  { title: '11. Not Financial Advice', body: 'Trimio shows you totals and dates based on what you entered. It does not provide financial, tax, legal, or investment advice, and nothing in the Service should be treated as a recommendation to buy, keep, or cancel anything.' },
  ...
  { title: '15. Suspension and Termination', body: 'You may stop using the Service and delete your account at any time. We may suspend or close an account that breaches these Terms, that is used unlawfully, or that puts the Service or other people at risk. Where it is reasonable to do so, we will tell you why and give you a chance to put things right.' },
  { title: '16. Liability', body: 'Nothing in these Terms limits liability that cannot be limited by law, including liability for death or personal injury caused by negligence, for fraud, or under mandatory consumer protection or product liability rules. Subject to that, we are not liable for indirect or consequential loss, and we are not liable for a subscription charge you incurred because a reminder was late, missing, or based on a date that was entered incorrectly. Our total liability in any twelve month period is limited to the greater of the amount you paid us in that period or fifty euro.' },
...
app.get('/privacy-policy', (req, res) => {
  res.set('Content-Type', 'text/html').send(legalPage(
    ...
    'Effective date: April 27, 2025 \u00b7 Last updated: August 14, 2026',
